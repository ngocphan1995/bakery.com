...
<div class="nv-block-banners">
	...
	<a href="{DATA.link}" onclick="this.target='{DATA.target}'" title="{DATA.file_alt}"> <img alt="{DATA.file_alt}" src="{DATA.file_image}" width="{DATA.file_width}" height="{DATA.file_height}" /><span class="hover_shine"></span> </a>
	<!-- END: type_image_link -->
	<!-- BEGIN: type_image -->
